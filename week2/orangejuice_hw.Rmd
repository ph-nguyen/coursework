...
interaction_reg_train <- lm(formula= logmove ~ logprice + brand + logprice*brand, data = train)
...
intercept_reg_mod2 <- lm(formula= logmove ~ logprice * brand + feat, data = oj)
 
interaction_reg_mod2 <- lm(formula= logmove ~ logprice * brand + feat + feat*logprice, data = oj)
summary(interaction_reg_mod2)

socio_mod <- lm(formula= logmove ~ logprice * brand + feat + feat*logprice + AGE60, data = oj)
summary(socio_mod)
